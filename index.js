...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `<h3>${game.name}</h3>
                            ...
                            <p>Funded: $${game.pledged.toLocaleString()} of $${game.goal.toLocaleString()} goal</p>`
...
// use reduce to find the total funding for all games
...
const displayStr = `A total of $${totalFunding.toLocaleString(
    ...
    numUnfundedGames === 1
      ? `${numUnfundedGames} game`
      : `${numUnfundedGames} games`
